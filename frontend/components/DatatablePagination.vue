        ...
        <div class="row q-gutter-x-md">
            ...
            <div class="q-table__control">
                <span class="q-table__bottom-item gt-sm">
                    Showing {{ pageStart }} to {{ pageEnd }} of {{ totalRows }} rows
                </span>
...
const pageStart = computed(() => 1 + (props.pagination.page * props.pagination.take) - props.pagination.take)
const pageEnd = computed(() => Math.min(props.totalRows, (pageStart.value - 1) + props.pagination.take))
